...
from chat.schema.message import RoomInfo ,UserInfo
from fastapi.exceptions import HTTPException
from auth.utils.dependency import login_required
apirouter  = APIRouter()
...
async def get_all_rooms(user=Depends(login_required)):
    """
...
async def get_room_info(room_id: str,user=Depends(login_required)):
    """
...
async def get_room_users(room_id: str,user=Depends(login_required)):
    """
...
async def get_all_users(user=Depends(login_required)):
    """
...
async def get_online_users(user=Depends(login_required)):
    """
...
async def get_user_info(username: str,user=Depends(login_required)):
    """
...
async def get_room_user_counts(user=Depends(login_required)):
    """
...
async def get_message_stats(user=Depends(login_required)):
    """
...
async def switch_user_room(username: str, room_id: str,user=Depends(login_required)):
    """
...
async def delete_empty_room(room_id: str,user=Depends(login_required)):
    """
